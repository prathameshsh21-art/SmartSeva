...
public class ServiceOrderMapper {
    ...
    public ServiceOrderDTO toDTO(ServiceOrder entity) {
        ...
        return ServiceOrderDTO.builder()
                ...
                .portalLoginId(entity.getPortalLoginId())
                .hasTemporaryPassword(entity.getEncryptedPortalPassword() != null && entity.getStatus() != com.smartseva.servicecatalog.entity.ServiceStatus.COMPLETED)
